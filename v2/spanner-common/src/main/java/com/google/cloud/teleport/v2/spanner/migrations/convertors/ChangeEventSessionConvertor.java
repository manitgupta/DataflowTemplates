...
public class ChangeEventSessionConvertor {
  ...
  private final SchemaOverridesParser schemaOverridesParser;
  ...
  public ChangeEventSessionConvertor(
      Schema schema,
      SchemaOverridesParser schemaOverridesParser, TransformationContext transformationContext,
      String sourceType,
  ...
  public JsonNode transformChangeEventViaOverrides(JsonNode changeEvent) {
    ...
    List<String> sourceColumnNames =
        StreamSupport.stream(
                Spliterators.spliteratorUnknownSize(sourceFieldNames, Spliterator.ORDERED), false)
