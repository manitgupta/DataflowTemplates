 ...
 */
@Template(
    name = "Cloud_Datastream_to_Spanner_Batch",
    category = TemplateCategory.STREAMING,
    displayName = "Datastream to Cloud Spanner Batch template",
    description = {
        "The Datastream to Cloud Spanner template is a batch pipeline that reads <a"
    ...
    flexContainerName = "datastream-to-spanner-batch",
    documentation =
...
public class DataStreamToSpannerBatch {
  private static final Logger LOG = LoggerFactory.getLogger(DataStreamToSpannerBatch.class);
  ...
  public static void main(String[] args) {
    ...
    LOG.info("Starting DataStream to Cloud Spanner Batch template");
